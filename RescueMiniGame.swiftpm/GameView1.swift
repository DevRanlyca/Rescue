...
struct GameView1: View {
    @Binding var goToView2 : Bool
    @State var view2Button: Bool = false
    ...
    var body: some View{
        ...
        ZStack {
            ...
            VStack (spacing:16) {
                ...
                Text("Drag the milk to Abu every 2 hours")
                    .foregroundColor(Color("main-black"))
                    .font(.system(size:17,design:.rounded))
                ...
                NavigationLink(
                    destination: GameView2(goToView3: self.$goToView2),isActive: $view2Button){}
                
                Button(action: {
                    self.view2Button = true
        ...
        .onReceive(timer) { time in
            ...
            if timeRemaining.isMultiple(of: 2) {
                isFeedingTime = true
                timer.upstream.connect().cancel()
            }
...
struct Gameview1_Previews: PreviewProvider {
    static var previews: some View {
        GameView1(goToView2: .constant(false))
    }
}
