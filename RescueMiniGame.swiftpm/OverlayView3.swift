        ...
        ZStack {
            ...
            ZStack{
                ...
                VStack(spacing:16){
                    ...
                    Text("Abu is gaining more independence with your care")
                    ...
                    VStack (spacing:8){
                        HStack {
                            ...
                            VStack(spacing:4){
                                ...
                                Text("complete set of teeth, true eye color emerge")
                                    .foregroundColor(Color("main-black"))
                                    .font(.system(size:16,design:.rounded))
                                    .multilineTextAlignment(.center)
...
struct OverlayView3_Previews: PreviewProvider {
